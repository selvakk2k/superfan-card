 ...
 */
const t=globalThis,i=t.ShadowRoot&&(void 0===t.ShadyCSS||t.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,s=Symbol(),o=new WeakMap;let n=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==s)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(i&&void 0===e){const i=void 0!==t&&1===t.length;i&&(e=o.get(t)),void 0===e&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&o.set(t,e))}return e}toString(){return this.cssText}};const r=i?e=>e:e=>e instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return(e=>new n("string"==typeof e?e:e+"",void 0,s))(t)})(e):e,{is:a,defineProperty:c,getOwnPropertyDescriptor:l,getOwnPropertyNames:d,getOwnPropertySymbols:h,getPrototypeOf:p}=Object,u=globalThis,f=u.trustedTypes,g=f?f.emptyScript:"",m=u.reactiveElementPolyfillSupport,b=(e,t)=>e,v={toAttribute(e,t){switch(t){case Boolean:e=e?g:null;break;case Object:case Array:e=null==e?e:JSON.stringify(e)}return e},fromAttribute(e,t){let i=e;switch(t){case Boolean:i=null!==e;break;case Number:i=null===e?null:Number(e);break;case Object:case Array:try{i=JSON.parse(e)}catch(e){i=null}}return i}},_=(e,t)=>!a(e,t),$={attribute:!0,type:String,converter:v,reflect:!1,useDefault:!1,hasChanged:_};
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const y=globalThis,w=e=>e,A=y.trustedTypes,S=A?A.createPolicy("lit-html",{createHTML:e=>e}):void 0,k="$lit$",C=`lit$${Math.random().toFixed(9).slice(2)}$`,P="?"+C,T=`<${P}>`,E=document,D=()=>E.createComment(""),z=e=>null===e||"object"!=typeof e&&"function"!=typeof e,L=Array.isArray,M="[ \t\n\f\r]",H=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,O=/-->/g,j=/>/g,U=RegExp(`>|${M}(?:([^\\s"'>=/]+)(${M}*=${M}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),N=/'/g,R=/"/g,I=/^(?:script|style|textarea|title)$/i,B=(e=>(t,...i)=>({_$litType$:e,strings:t,values:i}))(1),F=Symbol.for("lit-noChange"),W=Symbol.for("lit-nothing"),q=new WeakMap,G=E.createTreeWalker(E,129);function V(e,t){if(!L(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==S?S.createHTML(t):t}const J=(e,t)=>{const i=e.length-1,s=[];let o,n=2===t?"<svg>":3===t?"<math>":"",r=H;for(let t=0;t<i;t++){const i=e[t];let a,c,l=-1,d=0;for(;d<i.length&&(r.lastIndex=d,c=r.exec(i),null!==c);)d=r.lastIndex,r===H?"!--"===c[1]?r=O:void 0!==c[1]?r=j:void 0!==c[2]?(I.test(c[2])&&(o=RegExp("</"+c[2],"g")),r=U):void 0!==c[3]&&(r=U):r===U?">"===c[0]?(r=o??H,l=-1):void 0===c[1]?l=-2:(l=r.lastIndex-c[2].length,a=c[1],r=void 0===c[3]?U:'"'===c[3]?R:N):r===R||r===N?r=U:r===O||r===j?r=H:(r=U,o=void 0);const h=r===U&&e[t+1].startsWith("/>")?" ":"";n+=r===H?i+T:l>=0?(s.push(a),i.slice(0,l)+k+i.slice(l)+C+h):i+C+(-2===l?t:h)}return[V(e,n+(e[i]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),s]};class K{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let o=0,n=0;const r=e.length-1,a=this.parts,[c,l]=J(e,t);if(this.el=K.createElement(c,i),G.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(s=G.nextNode())&&a.length<r;){if(1===s.nodeType){if(s.hasAttributes())for(const e of s.getAttributeNames())if(e.endsWith(k)){const t=l[n++],i=s.getAttribute(e).split(C),r=/([.?@])?(.*)/.exec(t);a.push({type:1,index:o,name:r[2],strings:i,ctor:"."===r[1]?ee:"?"===r[1]?te:"@"===r[1]?ie:X}),s.removeAttribute(e)}else e.startsWith(C)&&(a.push({type:6,index:o}),s.removeAttribute(e));if(I.test(s.tagName)){const e=s.textContent.split(C),t=e.length-1;if(t>0){s.textContent=A?A.emptyScript:"";for(let i=0;i<t;i++)s.append(e[i],D()),G.nextNode(),a.push({type:2,index:++o});s.append(e[t],D())}}}else if(8===s.nodeType)if(s.data===P)a.push({type:2,index:o});else{let e=-1;for(;-1!==(e=s.data.indexOf(C,e+1));)a.push({type:7,index:o}),e+=C.length-1}o++}}static createElement(e,t){const i=E.createElement("template");return i.innerHTML=e,i}}function Y(e,t,i=e,s){if(t===F)return t;let o=void 0!==s?i._$Co?.[s]:i._$Cl;const n=z(t)?void 0:t._$litDirective$;return o?.constructor!==n&&(o?._$AO?.(!1),void 0===n?o=void 0:(o=new n(e),o._$AT(e,i,s)),void 0!==s?(i._$Co??=[])[s]=o:i._$Cl=o),void 0!==o&&(t=Y(e,o._$AS(e,t.values),o,s)),t}class Z{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,s=(e?.creationScope??E).importNode(t,!0);G.currentNode=s;let o=G.nextNode(),n=0,r=0,a=i[0];for(;void 0!==a;){if(n===a.index){let t;2===a.type?t=new Q(o,o.nextSibling,this,e):1===a.type?t=new a.ctor(o,a.name,a.strings,this,e):6===a.type&&(t=new se(o,this,e)),this._$AV.push(t),a=i[++r]}n!==a?.index&&(o=G.nextNode(),n++)}return G.currentNode=E,s}p(e){let t=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Q{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=W,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Y(this,e,t),z(e)?e===W||null==e||""===e?(this._$AH!==W&&this._$AR(),this._$AH=W):e!==this._$AH&&e!==F&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>L(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==W&&z(this._$AH)?this._$AA.nextSibling.data=e:this.T(E.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,s="number"==typeof i?this._$AC(e):(void 0===i.el&&(i.el=K.createElement(V(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(t);else{const e=new Z(s,this),i=e.u(this.options);e.p(t),this.T(i),this._$AH=e}}_$AC(e){let t=q.get(e.strings);return void 0===t&&q.set(e.strings,t=new K(e)),t}k(e){L(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const o of e)s===t.length?t.push(i=new Q(this.O(D()),this.O(D()),this,this.options)):i=t[s],i._$AI(o),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=w(e).nextSibling;w(e).remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class X{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,o){this.type=1,this._$AH=W,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=o,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=W}_$AI(e,t=this,i,s){const o=this.strings;let n=!1;if(void 0===o)e=Y(this,e,t,0),n=!z(e)||e!==this._$AH&&e!==F,n&&(this._$AH=e);else{const s=e;let r,a;for(e=o[0],r=0;r<o.length-1;r++)a=Y(this,s[i+r],t,r),a===F&&(a=this._$AH[r]),n||=!z(a)||a!==this._$AH[r],a===W?e=W:e!==W&&(e+=(a??"")+o[r+1]),this._$AH[r]=a}n&&!s&&this.j(e)}j(e){e===W?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ee extends X{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===W?void 0:e}}class te extends X{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==W)}}class ie extends X{constructor(e,t,i,s,o){super(e,t,i,s,o),this.type=5}_$AI(e,t=this){if((e=Y(this,e,t,0)??W)===F)return;const i=this._$AH,s=e===W&&i!==W||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,o=e!==W&&(i===W||s);s&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class se{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Y(this,e)}}const oe=y.litHtmlPolyfillSupport;oe?.(K,Q),(y.litHtmlVersions??=[]).push("3.3.3");const ne=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,ue={type:"superfan-card",name:"Indian BLDC Fan Card",description:"A premium custom Lovelace card for Indian BLDC ceiling fans (Atomberg, Superfan, Orient, Activa, Goldmedal).",preview:!0,domain:"fan",domains:["fan"],documentationURL:"https://github.com/selvakk2k/superfan-card"};window.customCards=window.customCards||[];const fe=window.customCards.findIndex(e=>"superfan-card"===e.type||"custom:superfan-card"===e.type);fe>=0?window.customCards[fe]=ue:window.customCards.push(ue);const ge={Breeze:"Simulates natural gusting wind by modulating motor RPM smoothly",Nature:"Simulates outdoor ambient air currents",Sleep:"Gradually steps down fan speed overnight to prevent chills",Boost:"Operates BLDC motor at maximum RPM for rapid air turnover",Eco:"Optimizes motor duty cycle for ultra-low power consumption","Speed Adjust":"Fine-tune discrete speed levels from the remote control","1 Hr Timer":"Automatically turns off the fan after 1 hour","2 Hr Timer":"Automatically turns off the fan after 2 hours","4 Hr Timer":"Automatically turns off the fan after 4 hours","6 Hr Timer":"Automatically turns off the fan after 6 hours","8 Hr Timer":"Automatically turns off the fan after 8 hours"};let me=class extends re{constructor(){super(...arguments),this._expanded=!1,this._ghDropdown=null,this._handleWindowClick=e=>{const t=e.composedPath();this._ghDropdown&&!t.includes(this)&&(this._ghDropdown=null)},this._touchTimer=null,this._isLongPress=!1}connectedCallback(){super.connectedCallback(),window.addEventListener("click",this._handleWindowClick)}disconnectedCallback(){window.removeEventListener("click",this._handleWindowClick),super.disconnectedCallback()}static get styles(){return pe}static getConfigForm(){return{schema:[{name:"entity",required:!0,label:"Fan Entity",selector:{entity:{domain:"fan",integration:"superfan_ir"}}},{name:"name",label:"Custom Title",selector:{text:{}}},{name:"theme",label:"Theme",selector:{select:{options:[{label:"Default HA Theme",value:"default"},{label:"Material You (Optimized for Material 3 Theme)",value:"material_you"}]}}},{name:"layout",label:"Card Layout",selector:{select:{options:[{label:"Default (Full)",value:"default"},{label:"Compact (Expandable)",value:"compact"}]}}},{name:"full_layout",label:"Full View Style",selector:{select:{options:[{label:"Classic",value:"default"},{label:"Google Home",value:"google_home"}]}}},{name:"",type:"expandable",title:"Theming & Colors",icon:"mdi:palette",schema:[{name:"accent_color",label:"Accent Color",selector:{ui_color:{}}},{name:"main_color",label:"Background Color",selector:{ui_color:{}}}]},{name:"",type:"expandable",title:"Companion Entities (Auto-Discovered if blank)",icon:"mdi:link-variant",schema:[{name:"control_source_sensor",label:"Control Source Sensor",selector:{entity:{domain:"sensor",integration:"superfan_ir"}}},{name:"ir_blaster_sensor",label:"IR Blaster Sensor",selector:{entity:{domain:["binary_sensor","infrared","remote"]}}}]}]}}static getStubConfig(e,t,i){const s=t.find(e=>e.startsWith("fan."))||"";return{type:"custom:superfan-card",entity:s}}_handleTouchStart(e){e&&(this._isLongPress=!1,this._touchTimer=setTimeout(()=>{this._isLongPress=!0,this._showToast(e)},500))}_handleTouchEnd(){this._touchTimer&&(clearTimeout(this._touchTimer),this._touchTimer=null)}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config={...e}}updated(e){if(super.updated(e),e.has("_config")){const e=this._config?.theme||"default";this.getAttribute("theme")!==e&&this.setAttribute("theme",e),this._config?.accent_color?(this.style.setProperty("--appliance-accent",this._config.accent_color),this.style.setProperty("--sf-accent",this._config.accent_color)):(this.style.removeProperty("--appliance-accent"),this.style.removeProperty("--sf-accent")),this._config?.main_color?(this.style.setProperty("--appliance-bg",this._config.main_color),this.style.setProperty("--sf-bg",this._config.main_color)):(this.style.removeProperty("--appliance-bg"),this.style.removeProperty("--sf-bg"))}}getCardSize(){return"compact"!==this._config?.layout||this._expanded?4:2}_haptic(e="light"){window.dispatchEvent(new CustomEvent("haptic",{detail:e}))}_sourceIcon(e){const t=(e||"").toLowerCase();return t.includes("remote")?"mdi:remote":t.includes("switch")?"mdi:toggle-switch":t.includes("blaster")||t.includes("failover")||"ir"===t?"mdi:remote-desktop":t.includes("cloud")||"mqtt"===t?"mdi:cloud-check":"mdi:remote-desktop"}_showToast(e){this._haptic("warning"),this.dispatchEvent(new CustomEvent("hass-notification",{bubbles:!0,composed:!0,detail:{message:e}}))}_setSpeed(e){this._haptic("selection"),this.hass.callService("fan","set_percentage",{entity_id:this._config.entity,percentage:e})}_toggle(){if(!this.hass||!this._config)return;this._haptic("medium");const e=this.hass.states[this._config.entity];e&&("off"===e.state?this.hass.callService("fan","turn_on",{entity_id:this._config.entity}):this.hass.callService("fan","turn_off",{entity_id:this._config.entity}))}_setPreset(e){this._haptic("light"),this.hass.callService("fan","set_preset_mode",{entity_id:this._config.entity,preset_mode:e})}_formatPresetName(e){return e?e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase()):""}_formatPresetLabel(e,t="mode"){if(!e)return"";let i=e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase());return"mode"===t?i=i.replace(/\s+Mode$/i,"").trim():"timer"===t&&(i=i.replace(/\s+Timer$/i,"").trim()),i}_getPresetIcon(e){const t=e.toLowerCase();return t.includes("breeze")?"mdi:weather-windy":t.includes("nature")?"mdi:nature":t.includes("smart")?"mdi:brain":t.includes("speed")?"mdi:swap-vertical":t.includes("eco")?"mdi:leaf":t.includes("wellness")?"mdi:heart-pulse":t.includes("ac")?"mdi:air-conditioner":t.includes("reverse")?"mdi:rotate-left":t.includes("sleep")?"mdi:bed-clock":t.includes("led")||t.includes("light")?"mdi:lightbulb-outline":t.includes("boost")?"mdi:rocket-launch-outline":t.includes("timer")||t.includes("hr")||t.includes("hour")?"mdi:timer-outline":"mdi:fan"}render(){if(!this._config||!this.hass)return null;const e=this._config.entity,t=e?this.hass.states[e]:void 0;if(!t)return B`
      ...
      <ha-card style="${_}">
        ...
        <div class="body-container">
          ...
          <div class="presets-container">
            ${g.length>0?B`
              ...
              <div class="pill-grid">
                ${g.map(e=>{const t=this._formatPresetLabel(e,"mode"),i=e.toLowerCase().includes("speed adjust"),s=Boolean(d&&"none"!==d&&!d.toLowerCase().includes("speed adjust")),o=ge[t]||ge[e]||"";let n=t;o&&(n+=` — ${o}`),a?c?i&&s&&(n="Deactivate current preset to adjust speed"):n="Turn on fan to activate preset":n="Device is offline";const r=o||n;return B`
                    <button
            ...
            ${m.length>0?B`
              ...
              <div class="pill-grid">
                ${m.map(e=>{const t=this._formatPresetLabel(e,"timer"),i=ge[e]||ge[t]||`Automatically turns off after ${t}`;let s=t;i&&(s+=` — ${i}`),a?c||(s="Turn on fan to set timer"):s="Device is offline";const o=i||s;return B`
                    <button
        ...
        <div class="footer-telemetry-row">
          <div class="connection-status-pill">
            <div class="status-dot ${r?"online":""}"></div>
    ...
    `:this._renderCompact(t,i,c,a,l,d,u,_)}_renderGoogleHomeFull(e,t,i,s,o,n,r,a,c,l,d,h){const p=i?n?this._formatPresetName(n):`${o}%`:s?"Off":"Offline";let u=[];if(3===r)u=[{label:"Low",pct:33},{label:"Med",pct:66},{label:"High",pct:100}];else if(5===r)u=[{label:"1",pct:20},{label:"2",pct:40},{label:"3",pct:60},{label:"4",pct:80},{label:"5",pct:100}];else if(6===r)u=[{label:"1",pct:17},{label:"2",pct:33},{label:"3",pct:50},{label:"4",pct:67},{label:"5",pct:83},{label:"6",pct:100}];else{const e=r>0?r:3,t=100/e;for(let i=1;i<=e;i++)u.push({label:`${i}`,pct:Math.round(i*t)})}const f=i?u.findIndex((e,t)=>Math.abs(e.pct-o)<=10||t===u.length-1&&o>=e.pct-10):-1,g=f>=0?u[f].label:`${o}%`,m=c.find(e=>n===e),b=n&&!m?n:null,v=h?"on"===h.state:s,_=d?d.state:null;return B`
