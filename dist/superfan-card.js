        ...
        <div class="body-container">
          ...
          <div class="presets-container">
            ${g.length>0?B`
              ...
              <div class="pill-grid">
                ${g.map(e=>{const t=this._formatPresetLabel(e,"mode"),i=e.toLowerCase().includes("speed adjust"),s=Boolean(d&&"none"!==d&&!d.toLowerCase().includes("speed adjust")),o=ue[t]||ue[e]||"";let n=t;o&&(n+=` — ${o}`),a?c?i&&s&&(n="Deactivate current preset to adjust speed"):n="Turn on fan to activate preset":n="Device is offline";const r=o||n;return B`
                    <button
